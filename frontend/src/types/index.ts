...
export type ExamQuestionIndex={total:number;question_ids:number[];answers?:Record<string,string[]>;expires_at?:string};
...
export type StudySession={id:string;certification_code:string;mode:string;total_questions:number;current_index:number;retry_of_session_id?:string|null;question?:Question;summary?:StudySummary};
