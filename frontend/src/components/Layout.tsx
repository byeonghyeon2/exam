...
export function Layout(){
  ...
  const requestNavigation=(event:MouseEvent<HTMLAnchorElement>,to:string)=>{
    if(!guard)return;
    event.preventDefault();setDestination(to);setLeaveError(null);
  };
