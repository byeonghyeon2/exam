...
export function Layout() {
  ...
  return <StudyExitGuardContext.Provider value={{ setGuard, requestExit }}><div className={dark ? 'app dark' : 'app'}>
    ...
    <aside><NavLink to="/" className="brand" onClick={event => requestNavigation(event, '/')}><img src="/icons/certexam-192.png" alt="합격비서 아이콘"/><div><b>합격비서</b><small>자격증 합격 비서</small></div></NavLink>
